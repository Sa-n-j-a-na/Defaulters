...
function Pt() {
  ...
  const fetchStudentData = async () => {
    try {
      ...
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/student?rollNumber=${formattedRollNumber}`);
  ...
  const fetchMentorData = async (rollNumber) => {
    try {
      const formattedRollNumber = rollNumber.toUpperCase();
      const response = await axios.get(`${process.env.REACT_APP_API_URL}/mentor?rollNumber=${formattedRollNumber}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const checkResponse = await axios.get(`${process.env.REACT_APP_API_URL}/checkEntry`, {
        params: {
      ...
      const response = await axios.post(`${process.env.REACT_APP_API_URL}/${currentView}`, formData);
